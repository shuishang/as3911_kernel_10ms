 ...
 *
 * \param key_select Select key for authentication. 0x60 selects key A and 0x61 selects key B.
 ...
 *
 * \param key_select Select key for authentication. 0x60 selects key A and
 *        0x61 selects key B.
 * \param block Block to authenticate for.
 * \param uid UID of the card we authenticate to.
 * \param uidLength Length of the UID pointed to by \a uid in bytes.
